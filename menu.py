...
class UI:
	...
	def newData(cls):
		...
		print("         [9] Change Huntbot Mode")
		print("         [10] Change Webhook Settings")
		print("         [11] Change Selfbot Commands")
		print("         [12] Change Daily Mode")
		print("         [13] Change Stop Time")
		print("         [14] Chage Sell Mode")
		print("         [15] Change Solve Captcha")
		print("         [16] Change Owo Casino Setting")
		print("         [17] Change Sound Music Setting")
		print("         [18] Change API 2Capcha Setting")
		print()
		print("╚═══════════════════════════════════════════╝")
	@classmethod
	def info(cls):
